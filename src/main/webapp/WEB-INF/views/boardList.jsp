...
<script>
    let msg = "${msg}";
    if(msg=="LIST_ERR")  alert("게시물이 없거나 목록을 가져오는데 실패했습니다.");
        ...
        <table>
            ...
            <c:forEach var="boardDto" items="${list}">
                <tr>
                    ...
                    <td class="title"><a href="<c:url value="/board/read${ph.sc.queryString}&bno=${boardDto.bno}"/>"><c:out value="${boardDto.title}"/></a> <c:out value="[${boardDto.comment_cnt}]"/> </td>
